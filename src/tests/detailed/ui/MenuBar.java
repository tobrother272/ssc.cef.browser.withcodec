...
public class MenuBar extends JMenuBar {
    ...
    private final SSCCefBrowser owner_;
    ...
    public MenuBar(SSCCefBrowser owner, CefBrowser browser, ControlPanel control_pane,
        ...
        newwindow.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                final SSCCefBrowser frame = new SSCCefBrowser(OS.isLinux(), false, false, null);
