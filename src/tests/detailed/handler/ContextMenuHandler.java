...
public class ContextMenuHandler implements CefContextMenuHandler {
    ...
    public void onBeforeContextMenu(
        ...
        model.addItem(MenuId.MENU_ID_PLAYYOUTUBE, "Play YTB");
        model.setEnabled(MenuId.MENU_ID_PLAYYOUTUBE, true);
    ...
    public boolean onContextMenuCommand(CefBrowser browser, CefFrame frame,
        ...
        switch (commandId) {
            ...
            case MenuId.MENU_ID_USER_FIRST:
                ...
                return true;
            case MenuId.MENU_ID_PLAYYOUTUBE:
                
                
                //
                
                
                //browser.executeJavaScript("document.getElementById(\"movie_player\").playVideo();alert('xxxxxxx')", browser.getURL(), 0);
                //browser.executeJavaScript("document.getElementById(\"movie_player\").getPlayerState()", browser.getURL(), 0);
                //System.out.println("run youtube");
                return true;
            default:
